...
def setup_platform(hass, config, add_devices, discovery_info=None):
    ...
    add_devices([BluetoothSpeakerDevice(hass, name, address, volume, cache_dir)])
    return True
...
class BluetoothSpeakerDevice(MediaPlayerDevice):
    ...
    def __init__(self, hass, name, address, volume, cache_dir):
    ...
    def play_media(self, media_type, media_id, **kwargs):
        ...
        command = "mplayer -ao {} -quiet -srate 44100 -channels 2 -volume {} {}".format(sink, volume, media_file);
